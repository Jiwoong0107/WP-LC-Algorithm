...
private:
    ...
    struct HeuristicResult {
        ...
        std::vector<Cost> first_c1, first_c2; // ★追加: 初回到達コストを記録
    };
    ...
    int UpdateWeakParetoSet(int v, const Cost& new_cost, int p_idx);
    bool CheckAndRecordCycle(int end_idx, int v, const Edge& edge);
    ...
    //HeuristicResult run_backward_spfa(int s, int t);   //|V|-1 ver
